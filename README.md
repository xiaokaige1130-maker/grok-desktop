...
| 版本 | 要点 |
|------|------|
| **0.8.9** | 记忆管理 · 消息复制图标 · 带上下文新任务分支 |
| **0.8.8** | Bootstrap 浮层 · 任务/计划/目标三模式 · 全局滚动条 |
...
| Version | Highlights |
|---------|------------|
| **0.8.9** | Memory management · message copy icon · context-aware task branching |
| **0.8.8** | Bootstrap overlays · Task/Plan/Goal modes · global scrollbars |
...
<p align="center">
  <strong>Grok Desktop 0.8.9</strong><br />
