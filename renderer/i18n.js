...
(function (global) {
  const STRINGS = {
    zh: {
      ...
      "page.memory.title": "跨会话记忆",
      "page.memory.desc": "让 Grok 在新对话里仍记得你的约定（写在 ~/.grok/memory）",
      "page.memory.enable": "启用记忆",
      "page.memory.add": "＋ 记一条",
      "page.memory.howtoTitle": "有什么用？",
      "page.memory.howtoBody":
        "例如「这个项目用 pnpm」「永远用中文回复」。开启后，之后新开的对话会自动检索这些内容，不用反复说明。也可在聊天里让 Grok「记住 xxx」；这里适合手动整理、编辑、备份。",
      "page.memory.emptyTitle": "还没有记忆文件",
      "page.memory.emptyBody": "先打开右上角「启用记忆」，再点「记一条」，或在对话中说「请记住：……」。",
      "page.memory.tipGlobal": "全局：所有项目共用的偏好",
      "page.memory.tipProject": "项目：某个目录/仓库专属约定",
    ...
    en: {
      ...
      "page.memory.title": "Cross-session memory",
      "page.memory.desc": "Let Grok remember your conventions across chats (~/.grok/memory)",
      "page.memory.enable": "Enable memory",
      "page.memory.add": "＋ Add note",
      "page.memory.howtoTitle": "Why use it?",
      "page.memory.howtoBody":
        "E.g. “this project uses pnpm” or “always reply in Chinese”. When enabled, new chats retrieve these notes automatically. You can also ask Grok to remember something; this page is for manual edit and backup.",
      "page.memory.emptyTitle": "No memory files yet",
      "page.memory.emptyBody": "Turn on Enable memory, add a note, or say “please remember: …” in chat.",
      "page.memory.tipGlobal": "Global: preferences shared across all projects",
      "page.memory.tipProject": "Project: conventions for one folder/repo",
      "page.skills.title": "Skills",
